...
public class AddController extends HttpServlet {
    ...
    private static final String ERROR = "shop-index.jsp";
    private static final String SUCCESS = "shop-index.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Tea tea = new Tea(id, name, price, quantity, name);
            boolean check = cart.add(tea);
            if (check) {
                double total=0;
                for(Tea t:cart.getCart().values()){
