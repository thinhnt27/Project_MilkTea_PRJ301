...
public class DeleteProductController extends HttpServlet {
    ...
    private static final String ERROR = "ManagerProductController";
    private static final String SUCCESS = "ManagerProductController";
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = ERROR;
        try {
            boolean checkDelete = dao.delete(pid);
                    if (checkDelete) {
                        url = SUCCESS;
                    }
        } catch (Exception e) {
